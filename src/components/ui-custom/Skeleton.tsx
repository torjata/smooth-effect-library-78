...
export function Skeleton({
  ...
  return (
    <div
      className={cn(
        "glassmorphism h-5 w-full rounded-md bg-muted dark:bg-muted/40 border border-border/5 dark:border-white/5",
...
export function CardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn("glassmorphism space-y-5 rounded-xl p-4 border border-border/5 dark:border-white/5", className)}>
